...
var BaseHandler = /** @class */ (function (_super) {
    ...
    BaseHandler.prototype.setDirectory = function (value) {
        ...
        if (!fs.existsSync(value))
            throw new DirectoryReferenceError_1.DirectoryReferenceError("setDirectory(...): Directory ".concat(value, " does not exist."));
    ...
    BaseHandler.prototype.load = function (emitReady) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var instances, _i, _a, file, parsedPath, MConstructor, Constructor, instance;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        instances = [];
                        if (!this.directory)
                            return [2 /*return*/, reject(new DirectoryReferenceError_1.DirectoryReferenceError("Directory is not set. Use setDirectory(path) or specify a 'directory' key to the constructor prior to loading."))];
                        if (!fs.existsSync(this.directory))
                            return [2 /*return*/, reject(new DirectoryReferenceError_1.DirectoryReferenceError("Directory \"".concat(this.directory, "\" does not exist.")))];
                        this.loadAndPopulateFiles(this.directory);
                        if (!this.files.length)
                            this.debug("No files found in supplied directory.");
                        else
                            this.debug("Files found:\n" + this.files.map(function (f) { return "- ".concat(f); }).join("\n"));
                        _i = 0, _a = this.files;
                        _b.label = 1;
                    case 1:
    ...
    BaseHandler.prototype.loadAndPopulateFiles = function (directory) {
