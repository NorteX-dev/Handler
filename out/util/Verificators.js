...
var Verificators = /** @class */ (function () {
    ...
    Verificators.verifyCommand = function (interaction, cmd) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (res) {
                        ...
                        // "guildIds" field
                        var guildIdInvalid = interaction.guild && cmd.guildIds && cmd.guildIds.length && !cmd.guildIds.includes(interaction.guild.id);
                        if (guildIdInvalid) {
