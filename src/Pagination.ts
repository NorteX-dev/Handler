...
import { InteractionCollector, Message, MessageActionRow, MessageButton, MessageComponentInteraction, MessageEmbed, TextBasedChannels } from "discord.js";
...
export class Pagination extends EventEmitter {
	...
	async create(dataset: Array<any>, channel: TextBasedChannels, initiatorId: string, perPage: number = 10, time: number = 60000) {
